#!/usr/bin/env python3
"""Prepare a fresh pinned BPZ checkout, then build unchanged C11 and C13 controls."""
...
def main():
    ...
    try:
        ...
        run('04_checkout',['git','checkout','-b','codex/shannon-consolidation',PIN])
        ...
        run('12_baseline_build',['lake','--rehash','--no-ansi','build','ShannonBounds.CapCertC11','ShannonBounds.CapCertC13'])
        report['status']='PASS_FRESH_PINNED_BPZ_C11_C13_CONTROLS'
